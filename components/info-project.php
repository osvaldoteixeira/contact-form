<?php
require_once 'svgs/svgs.php';
$info_project = '
<div class="info-project">
    <div class="about-project">
      <h1>Project Contact Form</h1>
      <p>
        Este projeto é uma aplicação simples que contém um formulário de contato, onde os visitantes podem deixar uma
        mensagem para o administrador. E ele só poderá visualizar após fornecer uma senha de acesso.
      </p>
      <br />
      <p>
